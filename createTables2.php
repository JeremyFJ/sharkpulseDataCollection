...
if (!$mobile_result && !$sptemp_result) {
    ...
    print_r (pg_fetch_row($sptemp_result));
    ...
    while($row = pg_fetch_row($mobile_result)) {
        ...
        echo "<td>". $row[0] ."</td> <td>".$row[1]."</td><td>". $row[2]."</td><td>".$row[3]. "</td><td>$row[4]</td><td>" .$row[5].
            "</td><td>".$row[6]. "</td><td>". $row[8]. '</td><td>'.$row[9].'</td><td><img src=/uploads'.$row[7].' height="10%"></td>
                <td><a href="choice.php/?action=approve&table=mobile_table&id='.$row[0].'"><img src="/img/green_check.png" height="10%"></a><a href="choice.php/?action=remove&table=mobile_table&id='.$row[0].'"><img src="/img/red_x.png" height="10%"</a></td>';
        echo '</tr>';
    ...
    while($row = pg_fetch_row($sptemp_result)) {
        ...
        echo "<td>". $row[0] ."</td> <td>".$row[1]."</td><td>". $row[2]."</td><td>".$row[3]. "</td><td>$row[4]</td><td>" .$row[5].
            "</td><td>".$row[6]. "</td><td>". $row[8]. '</td><td>'.$row[9].'</td><td><img src=/uploads'.$row[7].' height="10%"></td>
                <td><a href="choice.php/?action=approve&table=sharkpulse_temp&id='.$row[0].'"><img src="/img/green_check.png" height="10%"></a><a href="choice.php/?action=remove&table=mobile_table&id='.$row[0].'"><img src="/img/red_x.png" height="10%"</a></td>';
        echo '</tr>';
